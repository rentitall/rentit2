    ...
    return new Scaffold(
      bottomNavigationBar: new BottomNavigationBar(
        ...
        items: [
          ...
          new BottomNavigationBarItem(
              title: new Text('Profile'), icon: new Icon(Icons.person))
        ],
      ),
      appBar: new AppBar(
                            ...
                            decoration: new BoxDecoration(
                                ...
                                image: new DecorationImage(
                                    image: new NetworkImage(
                                        'https://docs.google.com/uc?id=1LSYS8Hw7EOdXucLqexwCKjT3W0xM-UBJ'),
                                    fit: BoxFit.cover)),
                          ),
                          new Text(
                            "Game Console",
                        ...
                        children: <Widget>[
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                                ...
                                image: new DecorationImage(
                                    image: new NetworkImage(
                                        'https://docs.google.com/uc?id=1FbpGY9lY59h_BRX95D5V0gjjO8iWJXqz'),
                                    fit: BoxFit.cover)),
                          ),
                          new Text("Cameras",
                              style: new TextStyle(fontSize: 16.0),
                        ...
                        children: <Widget>[
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                                ...
                                image: new DecorationImage(
                                    image: new NetworkImage(
                                        'https://docs.google.com/uc?id=1zCYXyXuHfKybCm6GTAOzu2C8CWsSKTdd'),
                                    fit: BoxFit.cover)),
                          ),
                          new Text('Sports',
                              style: new TextStyle(fontSize: 16.0),
